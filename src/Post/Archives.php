...
class Archives extends Base {
	...
	public $id_base = 'svbk_post_archives';
	...
	protected function args() {
		return array(
			'description' => __( 'Shows archive in a collapse', 'svbk-widgets' ),
		);
	}
	...
	public function widget( $args, $instance ) {
		 ...
		 */
		$where = apply_filters( 'getarchives_where', $sql_where, $this );
		 ...
		 * @param array  $r        An array of default arguments.
		 */
		$join = apply_filters( 'getarchives_join', '', $this );
